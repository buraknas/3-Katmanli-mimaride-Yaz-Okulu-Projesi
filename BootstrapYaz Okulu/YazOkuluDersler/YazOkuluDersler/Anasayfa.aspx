<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Anasayfa.aspx.cs" Inherits="YazOkuluDersler.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
  <form id="Form1" runat="server">
      <div class="form-group">
          ...
          <br />
          <div>
              <asp:Label for="TextBox1" runat="server" Text="Öğrenci Foto:" style="font-weight: bold"></asp:Label>
              <asp:TextBox ID="TextBox5" runat="server" CssClass="form-control"></asp:TextBox>
          </div>

      </div>
      <asp:Button ID="Button1" runat="server" Text="Kayıt" OnClick="Button1_Click" CssClass="btn-info" />
